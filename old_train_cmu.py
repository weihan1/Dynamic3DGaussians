...
def train(seq, exp):
    ...
    if os.path.exists(f"./output/{exp}/{seq}"):
        ...
        return
    if seq == "rose":
        md = json.load(open(f"./plant_data/{seq}_mini/transforms_train.json", 'r'))
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--scene", "-s", choices=["basketball", "boxes", "football", "juggle", "softball", "tennis", "rose"], default="rose")
